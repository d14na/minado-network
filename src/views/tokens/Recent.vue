<template>
    <div class="animated fadeIn">
        <b-card header="Recent Activity">
            ...
            <b-pagination size="md" :total-rows="100" v-model="currentPage" :per-page="10" class="mt-3"></b-pagination>
        </b-card>
    </div>
</template>
...
Tx:
From:
To: 0x9303b501e06aded924b038278ec70fe115260e28
47.00 0xBTC
$ 12.08(0.05%)
~$ 12.08@ 0.26
2
...
export default {
    ...
    data: () => ({
        ...
        tableItems: [{
            ...
            user: { name: '0xd55766c9 ... 6bc7b0b4', new: true, registered: '0x50212e78 ... 6d972e93' },
